...
import threading
from date_processing import process_mzml, create_dataframe, process_excel, process_eroi_date
...
class Application(tk.Tk):
    ...
    def start_processing(self):
        ...
        try:
            ...
            eroi_date = self.output_file_entry.get()

            if not mzml_file or not eroi_date:
            ...
            threading.Thread(target=self.run_process,
                             args=(mzml_file, eroi_date, Sampling_points_needed,
    ...
    def run_process(self, mzml_file, eroi_date, Sampling_points_needed, integer_range_start, integer_range_end, mz_min, mz_max, progress_callback):
        """调用数据处理函数执行流程"""
        try:
            ...
            process_eroi_date(row_df, eroi_date, mz_min, mz_max, integer_range_start, integer_range_end)
